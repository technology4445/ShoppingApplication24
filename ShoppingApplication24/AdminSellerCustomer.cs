...
{
    public class AdminSellerCustomer : Attribute, IActionFilter
    {
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            User admin = _context.Users.Where(x => x.AccessTocken == accessToken && x.Role.Name == "Admin" || x.Role.Name == "Seller" || x.Role.Name == "Customer").FirstOrDefault();
            if (admin == null)
            {
