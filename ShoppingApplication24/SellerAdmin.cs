...
{
    public class SellerAdmin : Attribute, IActionFilter
    {
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            User admin = _context.Users.Where(x => x.AccessTocken == accessToken && (x.Role.Name == "Admin" || x.Role.Name == "Seller") ).FirstOrDefault();
            if (admin == null)
            {
